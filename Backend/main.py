...
def salida():
    ...
    return json.dumps({'consola':consola,'errores': diccioErrores, 'simbolos': diccioSimbolos })
...
def traducir():
    ...
    global Simbolos
    Simbolos = ast.getTablaGlobal().getTabla3()
    # consola = str(ast.getConsola())
    ...
    for error in ast.errores:
        ...
        diccioErrores.append(objError)
    # print(ast.getTablaSimbolosGlobalInterpretada())
    return json.dumps({'errores': diccioErrores, 'simbolos': diccioSimbolos, 'c3d': c3d})
